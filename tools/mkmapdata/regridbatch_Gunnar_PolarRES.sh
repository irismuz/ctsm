...
module load ESMF/8.4.1-iomkl-2021b-ParallelIO-2.5.10 #from Mariana
...
RES=1x1
GRIDFILE=/cluster/home/irismuz/CTSM_EXICE/tools/mkmapgrids/SCRIPgrid_577x582pt_US-UMB_nomask_c240526.nc
phys="clm4_5"
